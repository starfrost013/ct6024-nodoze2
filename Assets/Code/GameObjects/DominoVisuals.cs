...
/// </summary>
static class DominoVisuals
{
    internal const int DOMINO_WIDTH = 175;
    internal const int DOMINO_HEIGHT = 256;
    ...
    internal const int DOMINO_SHEET_SIZE_X = 1280, DOMINO_SHEET_SIZE_Y = 1536;
    ...
    {
        internal int dominoTop, dominoBottom;
        internal int x, y;
        internal int width, height;

        // flip veritcally
        internal bool flipVert;
